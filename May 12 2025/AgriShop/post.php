...
if ($_SERVER["REQUEST_METHOD"] == "POST" &&
    isset($_POST['description'], $_POST['category'], $_POST['province'], $_POST['city'], $_POST['barangay'])) {
    ...
    $sql = "INSERT INTO posts (username, description, category, file_path, province, city, barangay, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, NOW())";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssss", $username, $description, $category, $file_path, $province, $city, $barangay);
